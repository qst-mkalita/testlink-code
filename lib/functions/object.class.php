...
abstract class tlDBObject extends tlObject implements iDBSerialization
{
   ...
   */
  static public function createObjectFromDB(
    &$db,
    $id,
    $className,
   ...
   */
  static public function createObjectsFromDBbySQL(
    &$db,
    $query,
    $column,
    $className,
   ...
   */
  static public function createObjectsFromDB(
    &$db,
    $ids,
    $className,
    $returnAsMap = false,
   ...
   * @return mixed the newly created objects on success, or null else
   */
  static public function bulkCreateObjectsFromDB(
    &$db,
    $ids,
    $className,
    $returnAsMap = false,
